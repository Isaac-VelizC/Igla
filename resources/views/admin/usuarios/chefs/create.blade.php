            ...
            <div class="card">
                <div class="card-body">
                    <div class="new-user-info">
                        ...
                        <br>
                        <form method="POST" action="{{ $isEditing ? route('update.docentes', $docente->id) : route('store.docentes') }}">
                            @csrf
                            @if($isEditing)
                                @method('PUT')
                            @endif
                                ...
                                <div class="col-sm-12 col-lg-6">
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="fname" name="nombre" value="{{ old('nombre', $isEditing ? $docente->nombre : '') }}" placeholder="Nombre">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="ap_pat">Apellido Paterno:</label>
                                            <input type="text" class="form-control" id="ap_pat" value="{{ old('paterno', $isEditing ? $docente->paterno : '') }}" placeholder="Apellido Paterno">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="ap_mat">Apellido Materno:</label>
                                            <input type="text" class="form-control" id="ap_mat" value="{{ old('materno', $isEditing ? $docente->materno : '') }}" placeholder="Apellido Materno">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="ci">Cedula de Identidad:</label>
                                            <input type="text" class="form-control" id="ci" value="{{ old('ci', $isEditing ? $docente->ci : '') }}" placeholder="Cedula de Identidad">
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="mobno" value="{{ old('telefono', $isEditing ? $docente->telefono : '') }}" placeholder="Numero de Celular">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="email">E mail:</label>
                                            <input type="email" class="form-control" id="email" value="{{ old('email', $isEditing ? $docente->email : '') }}" placeholder="E mail">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="fcontratado" name="contrato" value="{{ old('contrato', $isEditing ? $docente->contratado_en : '') }}">
                                        </div>
                                        <div class="form-group col-md-6">
