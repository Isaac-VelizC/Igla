                  ...
                  <div class="row no-gutters">
                     <div class="col-md-8">
                        <div class="card-body">
                           ...
                           <p class="mt-2">{{ $pregunta->descripcion }}</p>
                           <div class="mb-5 pt-2">
                              <p class="line-around text-gray mb-0"><span class="line-around-1">Información</span></p>
                           </div>
                           <div class="row">
                                <p><b>Tema: </b>{{$pregunta->tema->tema}}</p>
                                <p><b>Fecha:</b> Se resive respuestas hasta {{ $pregunta->limite }}</p>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                           ...
                           <tbody>
                              @if (count($estudiantes) > 0)
                                 @foreach ($estudiantes as $estud)
                                    <tr>
                                       <th>n</th>
                                       <th scope="row">{{ $estud->persona->nombre }}</th>
