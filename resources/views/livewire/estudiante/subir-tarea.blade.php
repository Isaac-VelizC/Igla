       ...
       <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form wire:submit.prevent='updatedFiles'>
                                <div class="col-xl-12 col-lg-12">
                                    <div class="row">
                                        <div class="text-center">
                                            <h4>Formulario para subir</h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-4">
                                            <div class="card-body">
                                                <label for="basic-url" class="form-label">Descripción (Opcional)</label>
                                                <div class="input-group mb-3">
                                                    <textarea class="form-control" wire:model='descripcion' rows="5" aria-describedby="basic-addon3"></textarea>
                                                </div>
                                            </div>
                                        </div>
