            ...
            <div class="col-lg-12">
              <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="index.html">
                  <img src="{{ asset('client/img/logo/logo.svg')}}" alt="Logo" />
                </a>
				...
				<div class="row">
					<div class="col-lg-3 col-sm-6">
						<div class="single-logo text-center">
							<img src="{{ asset('client/img/client-logo/lineicons.svg')}}" alt="">
						</div>
					</div>
					<div class="col-lg-3 col-sm-6">
						<div class="single-logo text-center">
							<img src="{{ asset('client/img/client-logo/uideck.svg')}}" alt="">
						</div>
					</div>
					<div class="col-lg-3 col-sm-6">
						<div class="single-logo text-center">
							<img src="{{ asset('client/img/client-logo/pagebulb.svg')}}" alt="">
						</div>
					</div>
					<div class="col-lg-3 col-sm-6">
						<div class="single-logo text-center">
							<img src="{{ asset('client/img/client-logo/graygrids.svg')}}" alt="">
						</div>
					</div>
				</div>
			</div>
